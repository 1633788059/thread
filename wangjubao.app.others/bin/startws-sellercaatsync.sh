...
echo -e "Starting havana monitor server $HOST_NAME ...\c"
	...
	STDOUT_LOG=$LOG_DIR/stdout.sellercats.log
	nohup $JAVA_HOME/bin/java $JAVA_OPTS -classpath $CONFIG_DIR:$LIB_JARS com.wangjubao.app.others.sellercatssyn.main.SellercatsMain >> $STDOUT_LOG 2>&1 &
